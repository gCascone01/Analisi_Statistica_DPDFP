...
```{r grafii di regressione, echo=FALSE}

#---- GRAFICI DI REGRESSIONE ----
for(country in countries){
  print(f_regressione(V_dataset[country,],D_dataset[country,],country))
}
...
#---- GRAFICI DI REGRESSIONE ----
for(country in countries){
  print(f_residui(D_dataset[country,],V_dataset[country,],country))
}
